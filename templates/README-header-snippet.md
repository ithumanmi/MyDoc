...
> **📅 Last reviewed:** Month 2026 (update whenever content changes)

**Hướng dẫn sử dụng**
- Thay `___` bằng tên domain/module tương ứng.
- Điều chỉnh đường dẫn `[← Back to ___]` nếu README nằm sâu hơn 2 cấp.
- Nếu chưa có file `resources/collected_links/___`, hãy tạo mới trước để đảm bảo link hoạt động.
- Giữ thông tin "Last reviewed" đồng bộ với ngày cập nhật ở cuối file (nếu có).