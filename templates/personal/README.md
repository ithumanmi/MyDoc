...
Related career/daily templates cũ: [`../daily-log.md`](../daily-log.md), [`../well-being/daily-performance-tracker.md`](../well-being/daily-performance-tracker.md) — vẫn dùng được; bản `personal/*` gọn hơn cho life-data.
