...
- [Charts.css](https://chartscss.org/) – Xây biểu đồ nhẹ cho web dự án cá nhân.
- [Observable Plot](https://observablehq.com/plot) – Thư viện visualize hiện đại, code trực tiếp trong notebook.
- [Datawrapper](https://www.datawrapper.de/) – Tool online tạo chart chuyên nghiệp, embed dễ dàng.
