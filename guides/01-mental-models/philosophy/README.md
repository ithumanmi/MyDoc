# 🏛️ Philosophy for Modern Life & Work

> **"The unexamined life is not worth living."** — Socrates

Chào mừng bạn đến với **Philosophy Domain**. Đây không phải là nơi học triết học để đi thi, mà là nơi trang bị **tư duy nền tảng** (Mental Models) giúp bạn sống tốt hơn, làm việc hiệu quả hơn và ra quyết định sáng suốt hơn trong kỷ nguyên hỗn loạn của công nghệ.

---

## 🎯 Tại sao Tech Workers cần Triết học?

1.  **Critical Thinking:** Trong thế giới ngập tràn Fake News và Hype (AI, Crypto), khả năng tư duy phản biện là vũ khí tối thượng.
2.  **Ethics in Tech:** Khi bạn code AI hay thuật toán, bạn đang định hình xã hội. Bạn cần khung đạo đức để biết "Should we build this?".
3.  **Resilience (Mental Health):** Tech industry đầy áp lực (Layoffs, Burnout). Chủ nghĩa Khắc kỷ (Stoicism) là liều thuốc tinh thần mạnh mẽ.
4.  **Meaning:** Kiếm nhiều tiền để làm gì? Triết học giúp bạn tìm câu trả lời cho "Why?".

---

## 🆘 Quick Start

**Cần giải quyết vấn đề ngay?** → [⚡ Quick Reference Guide](./quick-reference.md)  
Cheatsheet tra cứu nhanh: Decision trees, quotes, templates, và công cụ cho từng tình huống cụ thể.

---

## 🗺️ Learning Path: Từ Căn bản đến Ứng dụng

Lộ trình này được thiết kế đi từ nền tảng tư duy đến các ứng dụng thực tế trong công việc và cuộc sống.

### **🐣 Phase 1: Fundamentals (Nền tảng tư duy)**
...
*   **[Người giỏi nhìn thấy điều chưa xảy ra](./practical-applications/anticipate-before-you-leave.md):** ⭐ **NEW** Chạy thử việc trong đầu trước khi làm. Thất bại có 4 tầng — đừng sửa cách làm khi đáng ra phải đổi cuộc chơi.
...
*   **Philosophy for Product/Tech:** Ethics in Tech, Philosophy of AI, Product ethics → liên kết 02-wealth-business (đạo đức kinh doanh) & 03-career (nguyên tắc nghề nghiệp).
...
1.  **"Meditations"** - Marcus Aurelius (Khắc kỷ)
2.  **"Man's Search for Meaning"** - Viktor Frankl (Ý nghĩa cuộc sống)
3.  **"Sophie's World"** - Jostein Gaarder (Lịch sử triết học nhập môn)
4.  **"Think Again"** - Adam Grant (Tư duy phản biện)
5.  **"Justice: What's the Right Thing to Do?"** - Michael Sandel (Đạo đức học)

---

> **Note:** Domain này đang được xây dựng (Work In Progress). Các file sẽ được cập nhật dần theo lộ trình.
