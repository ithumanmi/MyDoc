# 🧮 Mathematics for Life (Toán học Ứng dụng)

> **"Toán học không chỉ là những con số, nó là ngôn ngữ của tư duy logic và cách vũ trụ vận hành."**

Module này không dạy bạn giải tích phức tạp để đi thi. Nó cung cấp các **mô hình tư duy toán học (Mathematical Mental Models)** để bạn ra quyết định thông minh hơn trong cuộc sống, kinh doanh và sự nghiệp.

---

## 🗺️ Lộ trình học (Learning Path)

### 🎲 1. Xác suất & Quản trị Rủi ro (Probability)
