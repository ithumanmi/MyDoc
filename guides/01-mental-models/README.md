...
## 🎯 Mục tiêu
1. Xây “thư viện mô hình” để nhìn cùng một vấn đề dưới nhiều lăng kính (science, history, psychology…).
...
| --- | --- | --- |
| History – Path Dependence | [Nokia Fall](../../case-studies/mental-models-analysis/history-analysis-nokia-fall.md) | Audit “đường ray” hiện tại của doanh nghiệp/cá nhân |
| Biology – Ecosystem | [Retail Corp vs Digital Predators](../../case-studies/mental-models-analysis/biology-analysis-corporate-ecosystem.md) | Vẽ chuỗi giá trị ngành bạn và xác định niche |
| Physics – Entropy | [Tech Corp Stagnation](../../case-studies/mental-models-analysis/physics-analysis-corporate-stagnation.md) | Đánh giá team/process có đang tăng entropy |
| Chemistry – Catalysts | [Viral App Social-X](../../case-studies/mental-models-analysis/chemistry-analysis-product-launch.md) | Tìm “chất xúc tác” trong chiến dịch marketing |

## 🧭 Cách dùng Hub
1. Audit nhanh → chọn trục yếu.
2. Theo lộ trình layer tương ứng (science/human/meta).
3. Áp dụng bằng cách gắn mental model với case study thật.
4. Kết nối sang các thư mục khác (Career, Wealth, Lifestyle) để triển khai.

> Cần tư vấn “stack mental model” cho dự án cụ thể? Hãy mở issue hoặc ping team.