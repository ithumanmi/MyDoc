...
**🧭 Tổng quan thư mục:** [Career Skills Hub](../README.md) – chọn lộ trình G1 → G4 trước khi lao vào từng module.
...
> 📌 **Life OS trước, tiền sau:** Hoàn thành [Life OS Framework](./life-os-framework.md) và [Anti-Slip System](./anti-slip-system.md) trước khi leo sang các mục Career/Sales. Đây là “Giai đoạn 1” trong Career Skills Roadmap.
...
*   **[Anti-Slip System](./anti-slip-system.md):** Hệ thống chống trượt để duy trì kỷ luật.
*   **[Life OS Framework](./life-os-framework.md):** Hệ điều hành cuộc đời (Notion/Obsidian).
