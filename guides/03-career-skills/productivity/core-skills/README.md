...
Tập hợp các kỹ năng nền tảng giúp xây Operating System cá nhân cho hiệu suất bền vững: từ năng lượng, chú tâm, deep work đến giao tiếp và ảnh hưởng.

## 📍 Navigate nhanh

- **[Core Skills Index](INDEX.md):** Lộ trình học đề xuất theo 5 tầng (Foundation → Focus → Influence → Inner OS → Expansion).
- **[Core Skills Tracker](core-skills-tracker.md):** Bảng log ritual/metrics để duy trì tiến bộ.
- **Templates:**
  - [Deep Work Scheduler](templates/deep-work-scheduler.md)

## 🧱 Foundation Skills
- [Energy Management](energy-management.md)
- [Attention Mastery](attention-mastery.md)
- [Time Management Systems](time-management-systems.md)
- [Eisenhower Matrix: Thoát bẫy tốn thời gian](eisenhower-matrix-traps.md)
...
- [Experience Digestion](experience-digestion.md)
