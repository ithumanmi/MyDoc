...
## 🔭 Bạn sẽ tìm thấy gì trong thư mục này?
...
## 🔁 Kết nối với các khu vực khác của Docs

- **Technical Deep Dive:** Tham khảo [domains/game-dev/](../../../domains/game-dev/README.md) cho Unity, C#, engine, shader.
- **Tài chính & gọi vốn:** Dùng thêm [resources/collected_links/finance-trading.md](../../../resources/collected_links/finance-trading.md) và [templates/publisher-financial-model](./publisher-financial-model.md) để dựng P&L.
- **Personal Brand & Networking:** Xem [chapters/08-personal-brand.md](../../../chapters/08-personal-brand.md) để build authority trước khi pitch publisher hoặc xin remote.
- **Time & Habit Systems:** Đọc [chapters/05-ky-luat-thoi-quen.md](../../../chapters/05-ky-luat-thoi-quen.md) và [templates/personal-metrics-dashboard.md](../../../templates/personal-metrics-dashboard.md) để track tiến độ.

> 🔄 **Loop đề xuất:** Audit năng lực → Chọn trụ cột → Áp dụng playbook → Đo lường (template/metrics) → Iteration 90 ngày.
