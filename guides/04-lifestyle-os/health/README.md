...
# Health OS — Theory hub

> [← Lifestyle OS](../README.md) | [Well-being (broader)](../well-being/README.md) | [Personal records](../../../personal/README.md)
>
> **Moved from** `health/` (stubs remain at old paths).

**Separation:** this folder = **protocols & science (theory)**. Your dated logs/metrics live in [`personal/`](../../../personal/README.md) — do not mix.
...
| HRV | [hrv-tracking.md](./hrv-tracking.md) |
| Toxins | [environmental-toxins.md](./environmental-toxins.md) |
| Supplements 101 | [supplements-101.md](./supplements-101.md) |

## Records (not here)

| Record | Where |
| --- | --- |
| Daily mood / sleep notes | `personal/daily/` |
| Meals / macros | `personal/nutrition/` |
| Weight, HRV exports | `personal/body/metrics.csv` |
| Habit streaks | `personal/habits/` |
