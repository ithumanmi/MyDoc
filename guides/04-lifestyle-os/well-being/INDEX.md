...
Sơ đồ rút gọn toàn bộ tài nguyên trong `guides/04-lifestyle-os/well-being/`. Mỗi bullet = 1 tệp + mô tả 1 dòng để bạn tra cứu nhanh.

## 🧬 Biohacking (Phần cứng cơ thể)

- **[⚙️ CNS Basics](./cns-basics.md)** – Giải phẫu hệ thần kinh trung ương, hiểu “CPU” của cơ thể.
- **[🧠 Dopamine System](./biohacking/dopamine-system.md)** – Reset dopamine, cai nghiện kích thích số.
- **[🛡️ Cortisol & Melatonin](./biohacking/cortisol-melatonin-system.md)** – Quản lý stress & nhịp ngủ-thức.
- **[🩸 Glucose & Insulin](./biohacking/glucose-insulin-system.md)** – Ổn định năng lượng, tránh brain fog.
