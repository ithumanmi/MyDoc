...
> Theory hardware (hormones/sleep/movement) lives in [`../health/`](../health/README.md).  
> This INDEX covers **well-being/** plus links into **health/**.

## 🧬 Health theory (was Biohacking)
...
- **[🧪 Neurotransmitters Guide](../health/neurotransmitters-guide.md)** – Tổng hợp Serotonin, GABA, Acetylcholine.
- **[🛌 Sleep Optimization](../health/sleep-optimization.md)** – Protocol ngủ sâu, phục hồi tế bào.
- **[🔁 Break the Sleep-Performance Loop](./sleep-performance-loop.md)** – Thoát vòng xoáy ngủ kém → ý chí thấp → ăn tạp → tăng cân → lười tập.
- **[🫀 HRV Tracking](../health/hrv-tracking.md)** – Đo lường điểm số sinh tồn (Stress & Khả năng hồi phục) bằng công nghệ HRV.
- **[🏃 Movement Protocols](../health/movement-protocols.md)** – Zone 2, HIIT, Strength để tối ưu circulation.
- **[🥗 Nutrition for Brain](../health/nutrition-for-brain.md)** – Ăn uống hỗ trợ não bộ & hormone.
- **[⚙️ Health OS Overview](../health/health-os-overview.md)** – Lộ trình Health OS 12 tuần.
- **[📋 Health Optimization Protocols](../health/health-optimization-protocols.md)** – Checklist Morning/Evening Routine.
- **[💊 Supplements 101](../health/supplements-101.md)** – Framework labs → supplement → safety.
- **[☣️ Environmental Toxins](../health/environmental-toxins.md)** – Bộ lọc chất phá rối nội tiết, vi nhựa và CO2 cực độc.
...
- **[🌊 High Performance & Flow](./high-performance.md)** – Flow state, Ultradian cycle, Deep Work.
- **[📊 Daily Performance Tracker](../../../templates/well-being/daily-performance-tracker.md)** – Template log năng lượng (Notion/Sheet).
