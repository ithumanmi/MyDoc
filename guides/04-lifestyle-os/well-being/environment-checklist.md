# 🌱 Environment Checklist (Light, Air, Noise, Workspace)

> **Goal:** Tạo "hardware" hỗ trợ hormone & năng lượng: ánh sáng chuẩn, không khí sạch, nhiệt độ ổn định, tiếng ồn kiểm soát.
...
- **Sound cues:** Tạo âm thanh mở/đóng ritual (chuông, nhạc cụ) để reset thần kinh.
- **Meetings:** Dùng micro riêng, bật background noise suppression.
- **Link:** [High Performance & Flow](./high-performance.md) – attention ritual.

## 4. Workspace Layout
- **Triangle:** Bàn (Focus) – Ghế thư giãn (Reflect) – Kệ vận động nhẹ (Move).
- **Cable & clutter:** Dọn dây/cáp mỗi tuần để giảm cognitive load.
- **Greenery:** 1-2 chậu cây/góc nhìn ra thiên nhiên → giảm cortisol.

## 5. Weekly Environment Reset (15’)
1. Dọn bàn, lau bụi.
2. Reset ánh sáng (đổi bóng/kiểm tra nhiệt độ màu).
3. Test air quality (CO₂ sensor / AirVisual).
