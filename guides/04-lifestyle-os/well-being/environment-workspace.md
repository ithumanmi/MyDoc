...
```mermaid
graph LR
    Sunlight((Morning Sunlight)) --> Cortisol
    Lights[Work Lights 4000-5000K] --> Focus
    WarmLights[Evening Warm Lights] --> Melatonin
    AirQuality[Air Quality <800ppm] --> Energy
    Humidity[Humidity 40-60%] --> Comfort
    Temp[Temp 20-24°C work / 18-22°C sleep] --> Recovery
    Noise[Noise <50dB & Ritual Sound] --> DeepWork
    Layout[Workspace Layout 3 Zones] --> Flow
