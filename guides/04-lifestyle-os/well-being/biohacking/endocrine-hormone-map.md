...
> [← Well-being](../README.md) | [Health OS](./health-os-overview.md) | [Personal tracking](../../../../personal/README.md)
>
...
Hệ nội tiết điều khiển phần lớn chức năng sinh lý: năng lượng, tâm trạng, giấc ngủ, cân nặng, phục hồi và sinh sản. Doc này là **bản đồ tổng** — không thay lab/bác sĩ. Khi cần đi sâu, nhảy sang deep-dive đã có.
...
| Lo âu, thèm ngọt, mất ngủ | Serotonin · Cortisol · Melatonin | [neurotransmitters-guide](./neurotransmitters-guide.md) · [cortisol-melatonin](./cortisol-melatonin-system.md) |
| Crash sau ăn, đói liên tục | Insulin · Ghrelin/Leptin · GLP-1 | [glucose-insulin-system](./glucose-insulin-system.md) |
| Stress kéo dài, mỡ bụng | Cortisol | [cortisol-melatonin-system](./cortisol-melatonin-system.md) |
| Khó ngủ / jet-lag lối sống | Melatonin · Cortisol | [sleep-optimization](./sleep-optimization.md) |
| Yếu drive, khó build cơ | Testosterone · Sleep · Cortisol | [testosterone-system](./testosterone-system.md) |
| Phục hồi kém, tập mãi không lên | GH · Sleep · Protein | Mục GH bên dưới + sleep |
| Huyết áp / giữ nước / đi tiểu nhiều khi uống rượu | Aldosterone · ADH · Adrenaline | Mục §5 |
...
- **Deep-dive:** [neurotransmitters-guide.md](./neurotransmitters-guide.md) (phần Serotonin)
...
- **Deep-dive:** [cortisol-melatonin-system.md](./cortisol-melatonin-system.md)
...
- **Deep-dive:** [cortisol-melatonin-system.md](./cortisol-melatonin-system.md) · [sleep-optimization.md](./sleep-optimization.md)
...
- **Deep-dive:** [glucose-insulin-system.md](./glucose-insulin-system.md)
...
- **Deep liên quan:** [sleep-optimization](./sleep-optimization.md) · [movement-protocols](./movement-protocols.md)
