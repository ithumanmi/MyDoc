...
```mermaid
flowchart LR
    Sleep((Sleep Hygiene)) --> Recovery
    Movement((Movement & VO2)) --> Metabolism
    Stress((Stress Hygiene)) --> NervousSystem
    Social((Social & Community)) --> Hormones
    Purpose((Purpose & Life OS)) --> Motivation

    Recovery --> Energy
    Metabolism --> Energy
    NervousSystem --> Energy
    Hormones --> Energy
