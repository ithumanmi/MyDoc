...
- Hormone control → map then **nhịp** then playbook then **một file / hormone** (`*-system.md`):  
  [`endocrine-hormone-map.md`](./guides/04-lifestyle-os/health/endocrine-hormone-map.md) →  
  [`hormone-rhythm-playbook.md`](./guides/04-lifestyle-os/health/hormone-rhythm-playbook.md) →  
