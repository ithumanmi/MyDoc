...
### **2. Link Health**
- [ ] Run `python scripts/check_links.py` to verify all internal/external links
...
**Script:** `scripts/check_dates.py` (see below for implementation)
...
1. **Run link checker:**
   ...
   - Update `meta/ops/LINK_AUDIT_REPORT.md`
...
- [ ] Run `python scripts/check_dates.py` to find outdated content
...
- [ ] Final link check: `python scripts/check_links.py`
...
1. **GitHub Action: Link Checker**
   - Auto-run `scripts/check_links.py` on every commit
